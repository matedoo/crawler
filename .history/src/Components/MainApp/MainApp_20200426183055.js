...
function MainApp(props) {
  const [elementsListState, setElementsListState] = useState({ elementsList: [], inputValue: '', error: '', title: ''})
  ...
  useEffect(() => {
    const myFetch = async () => {
      ...
      try {
        ...
        setIsLoading(false)
        setElementsListState(title: responseParsed)
